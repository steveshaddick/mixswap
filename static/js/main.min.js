...
var MixView = Backbone.View.extend({
    ...
    initialize: function() {
        ...
        this.songs.$el.on("click", ".song-wrapper", function() {
            ...
            if (a.options.songClick) {
                a.options.songClick(b);
            }
        });
...
var AudioPlayer = {
    ...
    play: function(a) {
        ...
        var b = a.attributes.songFile;
        var c = b.substr(b.lastIndexOf(".") + 1);
        var d = {};
        d[c] = b;
        this.$audioPlayer.jPlayer("setMedia", d).jPlayer("play");
