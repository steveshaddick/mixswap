...
var MixView = Backbone.View.extend({
    ...
    playSong: function(a, b) {
        ...
        var c = this.songs.collection.findWhere({
    ...
    setUnpublished: function() {
        ...
        $(".song-title").editable({
            ...
            a.dcTimeout = setTimeout(function() {
                a.dblClicked = false;
            }, 1e3);
        });
    ...
    renderInit: function() {
        ...
        this.songs.$el.on("click", ".song-wrapper", function() {
            if (b.isSorting) return;
            var a = b.isPublished ? 0 : 500;
            if (b.playTimeout) {
                clearTimeout(b.playTimeout);
            }
            $item = $(this).parent();
            b.playTimeout = setTimeout(function() {
                if (b.dblClicked) {
                    return;
                }
    ...
    init: function() {
        ...
        this.$audioPlayer1.jPlayer({
            ready: function() {
                a.isReady = true;
                if (a.readySong1) {
                    AudioPlayer.play(a.readySong1, a.readyPreload, a.readyPlay);
                }
            },
            ended: function() {
        ...
        this.$audioPlayer2.jPlayer({
            ready: function() {
                a.isReady = true;
                if (a.readySong2) {
                    AudioPlayer.play(a.readySong2, a.readyPreload, a.readyPlay);
                }
            },
            ended: function() {
                EventDispatcher.dispatchEvent("songEnded");
        ...
        EventDispatcher.addEventListener("songPlay", function(b) {
            a.play(b.song, b.preloadSong, b.autoPlay);
        });
    },
    play: function(a, b, c) {
        ...
        var d = a.attributes.songOrder % 2 === 1;
        if (!this.isReady) {
            this.readyPlay = c;
            if (d) {
                this.readySong1 = a;
        ...
        var e = d ? this.$audioPlayer1 : this.$audioPlayer2;
        var f = a.attributes.songFile;
        var g = f.substr(f.lastIndexOf(".") + 1);
        var h = {};
        h[g] = f;
        this.$audioPlayer1.jPlayer("option", "cssSelectorAncestor", "");
        this.$audioPlayer2.jPlayer("option", "cssSelectorAncestor", "");
        e.jPlayer("option", "cssSelectorAncestor", "#jp_container_1").jPlayer("setMedia", h);
        if (c) {
            e.jPlayer("play");
        }
        ...
        var i;
        if (b) {
            i = d ? this.$audioPlayer2 : this.$audioPlayer1;
            f = b.attributes.songFile;
            g = f.substr(f.lastIndexOf(".") + 1);
            h = {};
            h[g] = f;
            i.jPlayer("setMedia", h);
        }
