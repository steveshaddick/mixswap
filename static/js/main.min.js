...
var MixView = Backbone.View.extend({
    ...
    renderInit: function() {
        ...
        this.songs.$el.on("click", ".song-wrapper", function() {
            if (a.isSorting) return;
            $item = $(this).parent();
            var b = a.songs.collection.get($item.attr("id").replace("song_", ""));
            if (this.currentPlayingSong != b) {
                a.playSong(b);
            }
        });
        ...
        $("#btnAddComment").on("click", function() {
            ...
            var d = new CommentModel({
                ...
                text: b,
                mixId: a.model.get("id")
            });
            d.save();
            a.comments.collection.add(d);
            $("#txtAddComment").val("");
        });
        ...
        if (this.options.isPublished) {
            var b = this.songs.collection.findWhere({
                songOrder: 1
            });
            this.playSong(b, false);
        }
...
var CommentView = Backbone.View.extend({
    ...
    render: function() {
        ...
        $(".text", a).html(this.model.attributes.text);
        this.$el = a;
        return this;
    }
});
