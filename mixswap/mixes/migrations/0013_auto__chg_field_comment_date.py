...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mixes_comment', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Comment.date'
        db.alter_column(u'mixes_comment', 'date', self.gf('django.db.models.fields.DateField')())
