...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field primaryMix on 'Song'
        db.delete_table(db.shorten_name(u'mixes_song_primaryMix'))

        # Adding M2M table for field primary_mix on 'Song'
        m2m_table_name = db.shorten_name(u'mixes_song_primary_mix')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('song', models.ForeignKey(orm[u'mixes.song'], null=False)),
            ('mix', models.ForeignKey(orm[u'mixes.mix'], null=False))
        ))
        db.create_unique(m2m_table_name, ['song_id', 'mix_id'])


    def backwards(self, orm):
        # Adding M2M table for field primaryMix on 'Song'
        m2m_table_name = db.shorten_name(u'mixes_song_primaryMix')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('song', models.ForeignKey(orm[u'mixes.song'], null=False)),
            ('mix', models.ForeignKey(orm[u'mixes.mix'], null=False))
        ...
        # Removing M2M table for field primary_mix on 'Song'
        db.delete_table(db.shorten_name(u'mixes_song_primary_mix'))
    ...
    models = {
        ...
        u'mixes.song': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'primary_mix': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'primary+'", 'symmetrical': 'False', 'to': u"orm['mixes.Mix']"}),
