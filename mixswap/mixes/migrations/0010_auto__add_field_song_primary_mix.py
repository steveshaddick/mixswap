...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.primary_mix'
        db.add_column(u'mixes_song', 'primary_mix',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='primary+', to=orm['mixes.Mix']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Song.primary_mix'
        db.delete_column(u'mixes_song', 'primary_mix_id')
