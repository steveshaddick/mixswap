...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.song_file'
        db.add_column(u'mixes_song', 'song_file',
                      self.gf('django.db.models.fields.files.FileField')(default='file', max_length=100),
                      keep_default=False)


        # Changing field 'Mix.picture_file'
        db.alter_column(u'mixes_mix', 'picture_file', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Song.song_file'
        db.delete_column(u'mixes_song', 'song_file')


        # Changing field 'Mix.picture_file'
        db.alter_column(u'mixes_mix', 'picture_file', self.gf('django.db.models.fields.files.ImageField')(default='file', max_length=100))
