...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mix.date_published'
        db.alter_column(u'mixes_mix', 'date_published', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Mix.date_published'
        db.alter_column(u'mixes_mix', 'date_published', self.gf('django.db.models.fields.DateField')(default='0000-00-00 00:00:00'))
