...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field user_listens on 'Mix'
        m2m_table_name = db.shorten_name(u'mixes_mix_user_listens')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mix', models.ForeignKey(orm[u'mixes.mix'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['mix_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field user_listens on 'Mix'
        db.delete_table(db.shorten_name(u'mixes_mix_user_listens'))
    ...
    models = {
        ...
        u'mixes.mix': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'New Mix'", 'max_length': '50'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'user_listens': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'listens+'", 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        },
        u'mixes.mixsong': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'listens': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'mix': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mixes.Mix']"}),
            'song': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mixes.Song']"}),
            'song_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'})
        },
        u'mixes.song': {
